...
import {
  Search, Filter, Send, MessageSquare, AlertTriangle, ShieldCheck, DollarSign,
    ...
    <div className="space-y-6 pb-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        {[
          ...
          { label: "Payment Issues Logged", val: complaints.filter(c=>c.issueType==='Payment Dispute').length, icon: DollarSign, color: "text-emerald-500", bg: "bg-emerald-500/10" },
