...
import {
  TrendingUp, Award, DollarSign, Users, Store, ShieldAlert, Cpu, Database, Settings, ShieldCheck,
  CheckCircle, AlertTriangle, Eye, ArrowRight, Play, Upload, Save, PlayCircle, RefreshCw, Send, Plus, Search, Trash2, MapPin,
  ShoppingBag, Truck, Package, UserCheck, AlertCircle, Sparkles, Clock, ArrowUpRight, ArrowDownRight, Activity, Percent, Shield, Calendar, Globe,
  User, Mail, Phone, Lock, Edit, Download, FileText, Check, XCircle, ThumbsUp, Ban, LockOpen, Sliders, Star, Megaphone, Briefcase, Boxes
} from 'lucide-react'
            ...
            {(activeSubItem === 'Overview' || activeSubItem === 'Dashboard') && (
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                  {[
                    { title: 'Total Revenue', value: '₹12,45,800', change: '+18.4%', trend: 'up', trendData: [10, 12, 11, 15, 13, 17, 20], icon: DollarSign, color: 'text-emerald-500', glow: 'shadow-emerald-500/5 hover:border-emerald-500/30' },
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                  ...
                  <div className="lg:col-span-2 grid grid-cols-2 sm:grid-cols-4 gap-4">
                    {[
                      { title: 'Total Earnings', value: '₹15,62,400', desc: 'Net Platform Earnings', icon: DollarSign, color: 'bg-emerald-500/10 text-emerald-500' },
                ...
                <div className={`p-6 rounded-xl border ${theme === 'dark' ? 'bg-slate-900 border-slate-800' : 'bg-white border-slate-200'} shadow-sm`}>
                  ...
                  <div className="relative border-l border-slate-200 dark:border-slate-800 pl-6 space-y-6 ml-3">
                    {[
                      ...
                      { action: 'Payment Completed', details: 'Payout of ₹45,000 cleared to Nashik Pesticide Outlet', time: '4 hours ago', icon: DollarSign, color: 'bg-emerald-500 text-white', iconColor: 'text-emerald-500 border-emerald-500' },
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className={`p-5 rounded-xl border ${theme === 'dark' ? 'bg-slate-900 border-slate-800' : 'bg-white border-slate-200'} shadow-sm space-y-4`}>
                  ...
                  <div className="border p-4 rounded-xl dark:border-slate-800 border-slate-100 flex flex-col items-center justify-center bg-slate-950 text-white min-h-[160px]">
                    ...
                    <div className="flex items-center gap-2">
                      <span className="w-8 h-8 rounded-lg bg-emerald-500 flex items-center justify-center">🌾</span>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="space-y-6">
                  ...
                  <div className={`p-5 rounded-xl border ${theme === 'dark' ? 'bg-slate-900 border-slate-800' : 'bg-white border-slate-200'} shadow-sm text-center space-y-4`}>
                    ...
                    <div className="border border-dashed p-4 rounded-xl flex flex-col items-center justify-center dark:border-slate-800 border-slate-200">
                      <div className="w-14 h-14 rounded-full bg-slate-800 text-slate-400 flex items-center justify-center font-bold text-base mb-2">👤</div>
                  ...
                  <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/65 backdrop-blur-xs">
                    ...
                    >
                      <div className="flex justify-between items-center border-b pb-3 dark:border-slate-800 border-slate-100">
                        ...
                        <button onClick={() => { setSelectedUser(null); setIsEditingProfile(false); }} className="text-slate-400 hover:text-slate-200 font-bold text-sm">✖</button>
                      </div>
                  ...
                  <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/65 backdrop-blur-xs">
                    ...
                    >
                      <div className="flex justify-between items-center border-b pb-3 dark:border-slate-800 border-slate-100">
                        ...
                        <button onClick={() => { setSelectedEmployee(null); setIsEditingEmployee(false); }} className="text-slate-400 hover:text-slate-200 font-bold text-sm">✖</button>
                      </div>
                ...
                <div className={`p-5 rounded-xl border ${theme === 'dark' ? 'bg-slate-900 border-slate-800' : 'bg-white border-slate-200'} shadow-sm`}>
                  <div className="overflow-x-auto text-2xs font-semibold">
                    <table className="w-full text-left">
                      ...
                      <tbody>
                        {[
                          { name: 'Organic Fertilizers', icon: '🌱', subs: 6, products: 124, date: 'May 01, 2026', status: 'Active' },
                          { name: 'High-Yield Seeds', icon: '🌾', subs: 12, products: 458, date: 'May 04, 2026', status: 'Active' },
                          { name: 'Crop Protection Liquid', icon: '🧪', subs: 4, products: 92, date: 'May 10, 2026', status: 'Active' }
                  ...
                  <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/65 backdrop-blur-xs">
                    ...
                    >
                      <div className="flex justify-between items-center border-b pb-3 dark:border-slate-800 border-slate-100">
                        ...
                        <button onClick={() => setSelectedOrderId(null)} className="text-slate-400 font-bold text-sm">✖</button>
                      </div>
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                  ...
                  <div className={`lg:col-span-2 p-5 rounded-xl border ${theme === 'dark' ? 'bg-slate-900 border-slate-800' : 'bg-white border-slate-200'} shadow-sm space-y-4`}>
                    ...
                    <div className="space-y-3 text-2xs font-semibold">
                      {[
                        { rank: '🥇', name: 'Ramesh Patil', refs: '142 referrals', earned: '₹14,200', badge: 'Gold Referrer' },
                        { rank: '🥈', name: 'Suresh Deshmukh', refs: '98 referrals', earned: '₹9,800', badge: 'Silver Referrer' },
                        { rank: '🥉', name: 'Anita Kulkarni', refs: '84 referrals', earned: '₹8,400', badge: 'Bronze Referrer' },
                    ...
                    <table className="w-full text-left">
                      ...
                      <tbody>
                        {[
                          ...
                          { title: 'ðŸ› Pest Alert – Act Now', audience: 'All Farmers', sent: '12,450', delivered: '12,100', openRate: '68.4%' }
                        ].map((n, i) => (
                          <tr key={i} className="border-b dark:border-slate-700/50 border-slate-50">
                  ...
                  <div className={`p-5 rounded-xl border ${theme === 'dark' ? 'bg-slate-900 border-slate-800' : 'bg-white border-slate-200'} shadow-sm space-y-4`}>
                    ...
                    <div className="space-y-3 text-2xs">
                      <div>
                        ...
                        <input type="text" value={emailSubject} onChange={(e) => setEmailSubject(e.target.value)} placeholder="🌾 Exclusive Kharif Season Deal Inside!" className={`w-full p-2 rounded-lg border outline-none ${theme === 'dark' ? 'bg-slate-950 border-slate-800' : 'bg-slate-50 border-slate-200'}`} />
                      </div>
                      <div>
                  ...
                  <div className={`p-5 rounded-xl border ${theme === 'dark' ? 'bg-slate-900 border-slate-800' : 'bg-white border-slate-200'} shadow-sm space-y-4`}>
                    ...
                    <div className="space-y-3 text-2xs">
                      <div>
                        ...
                        <textarea rows={4} value={waMessage} onChange={(e) => setWaMessage(e.target.value)} placeholder="à¤¨à¤®à¤¸à¥à¤¤à¥‡! 🌾 AgriAI à¤®à¤§à¥à¤¯à¥‡ à¤–à¤°à¥€à¤ª à¤¹à¤‚à¤—à¤¾à¤® à¤‘à¤«à¤° à¤¸à¥à¤°à¥‚ à¤à¤¾à¤²à¥€ à¤†à¤¹à¥‡..." className={`w-full p-2 rounded-lg border outline-none resize-none ${theme === 'dark' ? 'bg-slate-950 border-slate-800' : 'bg-slate-50 border-slate-200'}`} />
                      </div>
                      <div>
                  ...
                  <div className={`p-5 rounded-xl border ${theme === 'dark' ? 'bg-slate-900 border-slate-800' : 'bg-white border-slate-200'} shadow-sm space-y-4`}>
                    ...
                    <div className="space-y-3 text-3xs font-semibold">
                      {[
                        ...
                        { post: 'ðŸ› Identify Crop Disease with AI', likes: '4,120', shares: '920' },
