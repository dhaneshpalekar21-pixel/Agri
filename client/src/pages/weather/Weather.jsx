...
import { CloudSun, Droplets, Wind, Thermometer, Leaf, RefreshCw } from 'lucide-react'
...
const weatherData = {
  ...
  icon: '⛅',
  forecast: [
    { day: 'Today', icon: '⛅', high: 32, low: 24, rain: '20%' },
    { day: 'Tue', icon: '🌧️', high: 28, low: 22, rain: '70%' },
    { day: 'Wed', icon: '🌦️', high: 29, low: 23, rain: '50%' },
    { day: 'Thu', icon: '☀️', high: 34, low: 25, rain: '5%' },
    { day: 'Fri', icon: '⛅', high: 31, low: 23, rain: '15%' },
  ],
}

const cropSuggestions = [
  { crop: 'Sugarcane', icon: '🎋', season: 'Kharif', confidence: 92, reason: 'High humidity + warm temps ideal' },
  { crop: 'Soybean', icon: '🌱', season: 'Kharif', confidence: 85, reason: 'Well-drained soil + monsoon timing' },
  { crop: 'Cotton', icon: '☁️', season: 'Kharif', confidence: 78, reason: 'Good temperature range for growth' },
  { crop: 'Onion', icon: '🧅', season: 'Rabi', confidence: 71, reason: 'Plan ahead for Rabi season' },
]
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div className="lg:col-span-1" style={{ background: 'linear-gradient(135deg, #1B5E20, #2E7D32, #43A047)', borderRadius: '1rem', padding: '1.5rem', color: 'white' }}>
          <div className="flex items-center justify-between mb-6">
            <div>
              <p className="text-sm opacity-70">📍 {weatherData.city}, Maharashtra</p>
