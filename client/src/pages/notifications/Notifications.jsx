...
import { Bell, Package, CreditCard, AlertTriangle, CheckCheck, Trash2 } from 'lucide-react'
import toast from 'react-hot-toast'

const demoNotifications = [
  { _id: 'n1', type: 'expiry', icon: '⚠️', title: 'Product Expiry Alert', message: 'Chlorpyrifos 500ml (Batch B003) expires in 8 days', isRead: false, time: '10 min ago', severity: 'red' },
  { _id: 'n2', type: 'stock', icon: '📦', title: 'Low Stock Alert', message: 'Urea Fertilizer 50kg — only 3 bags remaining', isRead: false, time: '25 min ago', severity: 'orange' },
  { _id: 'n3', type: 'udhari', icon: '💸', title: 'Udhari Due Reminder', message: 'Suresh Patil — ₹4,500 due. Due date: Jun 15', isRead: false, time: '1 hour ago', severity: 'orange' },
  { _id: 'n4', type: 'expiry', icon: '⚠️', title: 'Product Expiry Warning', message: 'DAP Fertilizer batch B002 expires in 21 days', isRead: true, time: '3 hours ago', severity: 'yellow' },
  { _id: 'n5', type: 'stock', icon: '📦', title: 'Out of Stock', message: 'Drip Tape 16mm — stock is now 0. Please reorder.', isRead: true, time: '1 day ago', severity: 'red' },
  { _id: 'n6', type: 'system', icon: '🔔', title: 'System Update', message: 'AgroERP has been updated to v2.1.0 with new features', isRead: true, time: '2 days ago', severity: 'blue' },
]
